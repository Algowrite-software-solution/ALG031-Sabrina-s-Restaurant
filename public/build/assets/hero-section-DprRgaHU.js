import{r as a,j as e}from"./app-BLusu4BU.js";import{u as t}from"./index-y8oyDUEf.js";function y(){const{ref:r,inView:o}=t({triggerOnce:!0,threshold:.1,delay:200}),{ref:s,inView:l}=t({triggerOnce:!0,threshold:.1,delay:300}),{ref:d,inView:c}=t({triggerOnce:!0,threshold:.1,delay:400}),{ref:p,inView:f}=t({triggerOnce:!0,threshold:.1,delay:500}),{ref:u,inView:h}=t({triggerOnce:!0,threshold:.1,delay:600}),i=["storage/videos/home/hero-background1.mp4","storage/videos/home/hero-background2.mp4","storage/videos/home/hero-background3.mp4"],[n,m]=a.useState(0),g=a.useRef(null),x=()=>{m(b=>(b+1)%i.length)};return e.jsxs("div",{id:"home",className:"relative flex h-screen w-full items-center justify-center text-center bg-center bg-cover",style:{backgroundImage:'url("storage/images/home/hero-background.webp")'},children:[e.jsx("video",{ref:g,className:"absolute top-0 left-0 w-full h-full object-cover",src:i[n],autoPlay:!0,loop:!1,muted:!0,playsInline:!0,onEnded:x},n),e.jsx("div",{className:"absolute inset-0 bg-gradient-to-b from-black/95 via-black/75 to-black/55"}),e.jsxs("div",{className:"relative z-10 flex flex-col items-center gap-y-14 xl:gap-y-8 2xl:gap-y-14 px-6 pt-40 md:pt-20 text-pure-white",children:[e.jsx("h1",{ref:r,className:`
