import{r as n,j as e}from"./app-C9ymvOgH.js";import{u as t}from"./index-DBE1RtAV.js";const l=["storage/images/home/our-story-image1.webp","storage/images/home/our-story-image2.webp","storage/images/home/our-story-image3.webp","storage/images/home/our-story-image4.webp"];function k(){const[s,o]=n.useState(0);n.useEffect(()=>{const m=setInterval(()=>{o(r=>(r+1)%l.length)},5e3);return()=>clearInterval(m)},[]);const{ref:d,inView:c}=t({triggerOnce:!0,threshold:.1,delay:100}),{ref:f,inView:h}=t({triggerOnce:!0,threshold:.1,delay:500}),{ref:a,inView:i}=t({triggerOnce:!0,threshold:.1,delay:500}),{ref:x,inView:g}=t({triggerOnce:!0,threshold:.1,delay:200}),{ref:u,inView:p}=t({triggerOnce:!0,threshold:.1,delay:300}),{ref:w,inView:y}=t({triggerOnce:!0,threshold:.1,delay:400}),{ref:b,inView:v}=t({triggerOnce:!0,threshold:.1,delay:400}),{ref:j,inView:N}=t({triggerOnce:!0,threshold:.1,delay:450});return e.jsx("section",{id:"about-us",className:"bg-deep-red h-full md:h-screen flex justify-center items-center",children:e.jsxs("div",{className:"flex flex-col container mx-auto md:flex-row py-20 md:py-0",children:[e.jsx("div",{className:"relative w-full md:w-1/2 pr-4 md:pr-10 lg:pr-15 p-4 py-0",children:e.jsxs("div",{ref:d,className:`
                    relative h-70 md:h-full
                    ${c?"fade-in-left-visible":"fade-in-left-initial"}
                  `,children:[l.map((m,r)=>e.jsx("img",{src:m,alt:`Sabrina's story image ${r+1}`,className:`
                    absolute inset-0 w-full h-full object-cover
                    transition-opacity duration-1000 ease-in-out
                    ${r===s?"opacity-100":"opacity-0"}
                  `},r)),e.jsxs("h2",{ref:f,className:`
                  font-milyuna absolute top-10 right-15 translate-x-1/2
                                text-[128px] md:text-[100px] lg:text-[128px] font-normal leading-none tracking-[.05em] hidden md:block
                  ${h?"fade-in-left-visible":"fade-in-left-initial"}
                `,children:[e.jsx("span",{className:"text-pure-white",children:"Ou"}),e.jsx("span",{className:"text-black",children:"r"})]}),e.jsx("h2",{ref:a,className:`
                ...
                `,children:"Each meal invites you to slow down, share, and savor — the Spanish way."})}),e.jsx("div",{className:"w-full md:w-1/2 flex justify-center md:justify-start mt-8 md:mt-0",children:e.jsx("a",{href:"#contact-us",ref:j,className:`
                ...
                `,children:"Contact Us"})})]})]})})}function O(){const[s,o]=n.useState(0);n.useEffect(()=>{const a=setInterval(()=>{o(i=>(i+1)%l.length)},5e3);return()=>clearInterval(a)},[]);const{ref:d,inView:c}=t({triggerOnce:!0,threshold:.1}),{ref:f,inView:h}=t({triggerOnce:!0,threshold:.1,delay:200});return e.jsx("section",{className:"bg-deep-red py-12 md:py-20 overflow-x-hidden",children:e.jsxs("div",{className:"container mx-auto flex flex-col md:flex-row",children:[e.jsx("div",{ref:d,className:`relative w-full md:w-1/2 p-4 lg:p-8 ${c?"fade-in-left-visible":"fade-in-left-initial"}`,children:e.jsxs("div",{className:"relative w-full aspect-[4/5] drop-shadow-2xl",children:[l.map((a,i)=>e.jsx("img",{src:a,alt:`Sabrina's story image ${i+1}`,className:`
                  absolute inset-0 w-full h-full object-cover
                  transition-opacity duration-1000 ease-in-out
