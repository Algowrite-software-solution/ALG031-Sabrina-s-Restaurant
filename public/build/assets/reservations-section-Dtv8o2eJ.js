import{a as V,u as R,r as o,j as e}from"./app-C9ymvOgH.js";import{u as i}from"./index-DBE1RtAV.js";import{F as l}from"./form-field-ByVe9RkE.js";function E(){const{ref:x,inView:u}=i({triggerOnce:!0,threshold:.1,delay:200}),{ref:f,inView:h}=i({triggerOnce:!0,threshold:.1,delay:300}),{ref:g,inView:b}=i({triggerOnce:!0,threshold:.1,delay:600}),{ref:v,inView:y}=i({triggerOnce:!0,threshold:.1,delay:700}),{data:s,setData:n,post:j,processing:w,errors:r,reset:d,wasSuccessful:m}=V({name:"",email:"",phone:"",date:"",adults:1,children:0}),{props:N}=R(),a=N.flash||{},[c,p]=o.useState(!1);o.useEffect(()=>{if(a.success_message||a.error_message){p(!0);const t=setTimeout(()=>p(!1),5e3);return()=>clearTimeout(t)}},[a]);function S(t){t.preventDefault(),j(route("reservation.store"),{preserveScroll:!0,onSuccess:()=>d()})}return o.useEffect(()=>{m&&d()},[m]),e.jsx("section",{id:"reservations",className:"bg-cream flex justify-center items-center h-full md:h-screen text-black py-8 md:py-4 px-4 md:px-8",children:e.jsxs("div",{className:"container mx-auto",children:[e.jsx("h2",{ref:x,className:`
          ...
          `,children:"An intimate dining experience awaits. Secure your spot and enjoy elegant Spanish cuisine, fine wine, and warm hospitality at Sabrina’s."})}),e.jsxs("div",{className:"w-full md:w-2/3 pl-0 md:pl-20 order-2",children:[e.jsxs("form",{ref:g,onSubmit:S,id:"reservations-form",className:`
              ...
              `,children:[e.jsx(l,{label:"Name",id:"name",value:s.name,type:"text",placeholder:"enter your name",onChange:t=>n("name",t.target.value)}),r.name&&e.jsx("div",{className:"error text-red-500",children:r.name}),e.jsx(l,{label:"Email",id:"email",value:s.email,type:"email",placeholder:"enter your email",onChange:t=>n("email",t.target.value)}),r.email&&e.jsx("div",{className:"error text-red-500",children:r.email}),e.jsx(l,{label:"Phone",id:"phone",value:s.phone,type:"tel",placeholder:"enter your number",onChange:t=>n("phone",t.target.value)}),r.phone&&e.jsx("div",{className:"error text-red-500",children:r.phone}),e.jsx(l,{label:"Date",id:"date",value:s.date,type:"date",placeholder:"Select the date",onChange:t=>n("date",t.target.value)}),r.date&&e.jsx("div",{className:"error text-red-500",children:r.date}),e.jsxs("div",{className:"flex w-full flex-col md:flex-row md:items-center",children:[e.jsx("label",{className:"font-outfit text-[14px] md:text-[18px] lg:text-[21px] font-normal text-left w-full md:w-1/4 mb-1 md:mb-0",children:"Party Size"}),e.jsxs("div",{className:"flex w-full md:w-3/4 gap-4",children:[e.jsx("input",{type:"number",placeholder:"Adults",min:"0",className:`font-outfit text-[14px] md:text-[18px] lg:text-[21px] font-light w-1/2 bg-transparent border-b-1 
                        ...
                        ${a.success_message?"bg-deep-red":"bg-gray-700"}
                        ${c?"opacity-100":"opacity-0"}
                    `,children:a.success_message||a.error_message})]})]}),e.jsx("div",{className:"mt-12 md:mt-16 flex justify-center md:justify-end",children:e.jsx("button",{type:"submit",disabled:w,form:"reservations-form",ref:v,className:`
